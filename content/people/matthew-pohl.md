...
In sworn testimony, Captain Pohl admitted to deleting text messages relevant to the incident:

- Text messages from the period surrounding the arrest were deleted
- These communications were relevant to a foreseeable legal matter
- No litigation hold was in place to preserve evidence
- The deletion occurred despite the obvious need to preserve records

## Credibility Assessment

| Factor | Assessment |
|--------|------------|
| Relationship to Arrestee | Close Friend |
| Evidence Handling | **Deleted Texts** |
| Neutrality | **Compromised** |

## Legal Exposure

The deletion of relevant communications exposes Captain Pohl and the department to:
...
Captain Pohl provided sworn testimony regarding these events. His deposition is available for review.
